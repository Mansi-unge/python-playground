...
product_union = branch_a_products | branch_b_products
print(product_union)

product_intersection = branch_a_products & branch_b_products
print(product_intersection)

product_in_a = branch_a_products - branch_b_products
print(product_in_a)
